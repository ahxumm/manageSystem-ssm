								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/orders/orderAdd.do'">
...
<%--												onclick="location.href='${pageContext.request.contextPath}/traveller/addOrder.do?id=${orders.id}'"--%>
												<button type="button" class="btn bg-olive btn-xs" data-toggle="modal" data-target="#myModal" onclick="Values(${traveller.id})">添加订单</button>
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<div class="col-md-2 title"><h5>订单编号:</h5></div>
																<div class="col-md-4 data">
																	<select class="form-control select2" style="width: 100%"
																			id="orderId">
																				<c:forEach items="${orders}" var="orderdemo">
																					<option value="${orderdemo.id}">${orderdemo.orderNum}</option>
																				</c:forEach>
																	</select>
																</div>
															</div>
															<div class="modal-footer">
																...
																<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="addOidTid()">确认</button>
															</div>
														</div>
													</div>
												</div>
	...
	<script>
		...
		function changePageSize() {
			...
			//向服务器发送请求，改变没页显示条数
			location.href = "${pageContext.request.contextPath}/orders/findAll.do?page=1&size=" + pageSize+"&orderId="+orderId;
		};
		...
		function addOidTid(){
			...
			location.href = "${pageContext.request.contextPath}/traveller/addOrderId.do?travellerId="+travellerID+"&orderId="+orderID;
		};
