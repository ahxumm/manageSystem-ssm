...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/productEditFinsh.do?id=${product.id}" method="post">
				<!-- 正文区域 -->
...
<%--									<option value="关闭" <c:if test='${product.productStatus==0}'>selected="selected"</c:if>></option>--%>
							</select>
						</div>
