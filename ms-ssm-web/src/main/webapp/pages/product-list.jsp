...
<body class="hold-transition skin-purple sidebar-mini">
						...
						<div class="table-box">
							...
							<div class="col-lg-6" style="float: right">
								<div class="input-group">
									<input type="text" id="keywords" class="form-control" placeholder="输入产品名称搜索" style="width: 240px;float: right">
									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/product/productEdit.do?id=${product.id}'">编辑</button>
												<c:choose>
													<c:when test="${product.productStatusStr == '关闭'}">
														<button type="button" class="btn bg-olive btn-xs" onclick='changeProductStatus("${product.id}")'>开启</button>
													</c:when>
													<c:otherwise>
														<button type="button" class="btn bg-olive btn-xs" onclick='changeProductStatus("${product.id}")'>关闭</button>
													</c:otherwise>
												</c:choose>
											</td>
										</tr>
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="deleteById();">删除</button>
													</div>
												</div>
											</div>
										</div>
	...
	<script  type="text/javascript">
		...
		function changePageSize() {
			...
			//alert(keywords)
			//向服务器发送请求，搜索
			location.href = "${pageContext.request.contextPath}/product/findAll.do?page=1&size="+pageSize+"&probuctName="+keywords;
		}
		...
		function changeProductStatus(id) {
			...
			$.ajax({
				type: "post",
				url: "${pageContext.request.contextPath}/product/changeProductStatus.do",
				data: id,
		...
		function deleteById() {
			...
			for (k in checkboxs){
				if(checkboxs[k].checked)
					chekboxList1.push(checkboxs[k].value)
			}
			chekboxList = JSON.stringify(chekboxList1)
			$.ajax({
				type: "post",
